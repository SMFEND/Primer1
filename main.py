...
Am, C_history = amortization1(C=50000, T=9, L=0)
print(f"Am = {Am}\nC_history = {C_history}")
...
def amortization2(C: float, T: int,
                  k: float) -> Tuple[List[float], List[float]]:
  """
...
Am_history_2, C_history_2 = amortization2(C=50000, T=9, k=2)
...
# Вариант 5
Am_linear, C_history_linear = amortization1(C=50000, T=9, L=0)
